...
print('Exercise 3:', apply_discount(50, -5))   
...
print('Exercise 5: Sum to 10:', sum_to(10)) 
...
print('Exercise 6: Largest among 10, 4, 2:', largest(10, 4, 2)) 
print('Exercise 6: Largest among -5, -10, -2:', largest(-5, -10, -2))
...
print('Exercise 7: Tip for $50 with 20%:', calculate_tip(50, 20))
print('Exercise 7: Tip for $100 with 15%:', calculate_tip(100, 15))
print('Exercise 7: Tip for $75 with 18%:', calculate_tip(75, 18)) 
...
print('Exercise 8:', product(1, 3, 7))
